...
const config = require('../config/ssh.json');
...
describe('SSH', function () {
    ...
    describe('exec', function () {
        ...
        it('should capture the exit code', function (done) {
            const exitCode = Math.round(Math.random() * 200);
            ssh.exec('exit', {
                args: [exitCode],
                exit: function (code) {
